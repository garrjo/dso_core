...
1. **realtime_dashboard_dso.html** - Enhanced dashboard with DSO physics
2. **dso_seismic_model.py** - Python model with validation
3. **dso_seismic_report.py** - Analysis report generator
